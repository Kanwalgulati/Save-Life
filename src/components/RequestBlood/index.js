...
function RequestBlood({ getUserId }) {
  ...
  return (
    <div className="login request">
      <Card variant="outlined">
        <CardContent>
          <h1>
            <img src={request} alt="request" className="logo4" /> Request For
            Blood
          </h1>
          <form onSubmit={submit1}>
            ...
            <p style={{ paddingTop: 20, marginLeft: 60 }}>
              Gender{" "}
              <RadioGroup
                row
                aria-label="position"
            ...
            <p style={{ paddingTop: 10, marginLeft: 60 }}>
              <TextField
